...
playlists = {
    "Classical": [
        "https://open.spotify.com/playlist/37i9dQZF1DWZd79rJ6a7lp?si=2J1wBa3NTDS7740y170bGQ",
        "https://open.spotify.com/playlist/37i9dQZF1DX1n9whBbBKoL?si=isTYzk7bSbCj_n0V3MPKeQ"
    ],
    "Noise": [
        "https://open.spotify.com/playlist/37i9dQZF1DX03b46zi3S82?si=TWuJOEcxQq2vXTAFMgVyqw",
        "https://open.spotify.com/playlist/37i9dQZF1DXa1rZf8gLhyz?si=lQXEP5S_SdmAp7fGMfWEfg"
    ],
    "Lofi": [
        "https://open.spotify.com/playlist/37i9dQZF1DX2PQDq3PdrHQ?si=IgZ8j__dQRKTvlMVWGktdg",
        "https://open.spotify.com/playlist/37i9dQZF1DXbcPC6Vvqudd?si=PZBBcMagSzy-1rD31kh4rQ"
    ],
    "Instrumental": [
        "https://open.spotify.com/playlist/37i9dQZF1DXa1rZf8gLhyz?si=lQXEP5S_SdmAp7fGMfWEfg",
        "https://open.spotify.com/playlist/37i9dQZF1DX03b46zi3S82?si=TWuJOEcxQq2vXTAFMgVyqw"
...
@app.route('/about')
def about():
    return render_template('about.html', title='Music')


@app.route('/recommendation', methods=['POST'])
def recommendation():
    selected_type = request.form['music_type']
    
    # Get a random playlist from the selected type
    selected_playlist = random.choice(playlists[selected_type])
    
    return render_template('recommendation.html', playlist=selected_playlist)
...
def sound_alarm():
    AudioSegment.from_wav.play('alarm2.mp3')
